...
const corsOptions = {
  origin: [
    'https://frontend-base-wert-hewu4olzh-willifes-projects.vercel.app',
    'https://wert-soluctions-technology.duckdns.org',
    'http://localhost:3000',
  ],
  methods: ['GET', 'POST', 'PUT', 'PATCH', 'DELETE', 'OPTIONS'],
  allowedHeaders: ['Content-Type', 'Authorization'],
  credentials: true, // Adicione isso se estiver usando cookies
};
